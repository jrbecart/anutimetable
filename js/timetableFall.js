...
var Course = {
    ...
    loadTimetable: function() {
        //test
        $.get('./data/timetableFall.json?VERSION=' + revisionNum + '&time=' + Date.now(), {}, function (data) {
...
if (typeof global === 'undefined' || typeof global.it !== 'function') {
    $(function () {
        ...
        $.get('./data/configTableFall.json' + '?time=' + Date.now(), {}, function (data) {
