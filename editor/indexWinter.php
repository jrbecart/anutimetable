...
<html lang="en">
    ...
    <body>
    <div class="container">
<h1>TimeTable Configuration Editor (WINTER)</h1>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            jsonEditorInit('table_container', 'Textarea1', 'result_container', 'json_to_table_btn', 'table_to_json_btn', 'new_line', 'Winter');
